...
export function TotalsPage() {
  ...
  const handleExportOverduePdf = async () => {
    try {
      ...
      if (!Array.isArray(rows)) {
        toast({
          title: 'La API de vencidos no devolvió un listado',
          status: 'error',
          duration: 3000,
          isClosable: true,
        });
      ...
      toast({
        title: 'No se pudo generar el PDF de vencidos',
        status: 'error',
        duration: 3000,
        isClosable: true,
      });
  ...
  const handleExportPendingPerAccountMonthPdf = async () => {
    try {
      ...
      if (!Array.isArray(rows)) {
        toast({
          title: 'La API no devolvió un listado',
          status: 'error',
          duration: 3000,
          isClosable: true,
        });
      ...
      toast({
        title: 'No se pudo generar el PDF de pendientes por cuenta/mes',
        status: 'error',
        duration: 3000,
        isClosable: true,
      });
